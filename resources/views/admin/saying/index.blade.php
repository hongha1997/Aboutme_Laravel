            ...
            <div class="content-box-large">
                <div class="row">
                    <div class="panel-heading">
                        <div class="panel-title ">Quản lý Saying</div>
                    </div>
                </div>
                <hr>    
                <div class="row">
                    <div class="col-md-8">
                        <a href="{{route('admin.saying.add')}}" class="btn btn-success"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span>&nbsp;Thêm</a>
                ...
                <div class="panel-body">
                    ...
                    <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                        ...
                        <tbody>
                            ...
                            @php
                                $id_saying      = $saying->id_saying;
                                $content        = $saying->content;
                                $author         = $saying->author;
                                $urlEdit        = route('admin.saying.edit', $id_saying);
                                $urlDel         = route('admin.saying.del', $id_saying);
                            @endphp
                            <tr class="odd gradeX">
                                <td>{{$id_saying}}</td>
                                <td>{{$content}}</td>
