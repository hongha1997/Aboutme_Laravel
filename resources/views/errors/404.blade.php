...
<!-- /font files -->
<!-- css files -->
<link href="/templates/error/css/style.css" rel="stylesheet" type="text/css" media="all" />
<!-- /css files -->
<!-- js files -->
...
<div class="container demo-2">
	<div class="content">
        <div id="large-header" class="large-header">
			<h1 class="header-w3ls">Không tồn tại !!!</h1>
            <canvas id="demo-canvas"></canvas>
			<img src="/templates/error/images/owl.gif" alt="flashy" class="w3l">
            <h2 class="main-title">404</span></h2>
        </div>
	</div>
</div>	
<!-- js files -->
<script src="/templates/error/js/rAF.js"></script>
<script src="/templates/error/js/demo-2.js"></script>
<!-- /js files -->
</body>
</html>